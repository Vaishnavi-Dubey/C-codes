...
//when we need to store the address of a pointer variable, we cannot assign it in a pointer variable.
// To store address of a pointer variable, we use a double pointer which is also known as pointer to pointer.
#include <stdio.h>

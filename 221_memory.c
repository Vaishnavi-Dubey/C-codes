...
int main() {
    ...
    // The memory allocated by calloc will be zero-initialized,
    ...
    // all of the values are initialized to zero.
    ...
    // which is unavailable in this case, and so the allocation fails and returns NULL.

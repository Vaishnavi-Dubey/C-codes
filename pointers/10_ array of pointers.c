// 10_ array of pointers.c

/*C program to demonstrate example of array of pointers.*/
//"Array of pointes" is an array of the pointer variables.
// Here, we are declaring an array of integer pointer int *ptr[3]; it will store the address of integer variables.
#include <stdio.h>
